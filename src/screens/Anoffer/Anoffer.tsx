...
function Anoffer({ route, navigation }) {
  ...
  useFocusEffect(
    useCallback(() => {
      amplitude.logEvent("Click en una oferta", {
        title: title,
      });
    }, [])
  );
      ...
      <Layout route={route} navigation={navigation} title={mainTitle}>
        <ScrollView>
          <Box mx="3" mt="3" mb={"48"}>
            ...
            {name && (
              <Box p={3} mt="3" mb={3} rounded={8} backgroundColor={"white"}>
                <Text fontSize={14}>
            ...
            <Box p={3} mt={3} rounded={8} backgroundColor={"white"}>
              <Text style={[fontStyles.headingText, { fontSize: 16 }]} mb="3">
                Descripción:{" "}
              </Text>
