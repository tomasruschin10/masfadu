    ...
    <Stack.Navigator>
      ...
      {!token ? (
        ...
        <Stack.Group screenOptions={{
          ...
          <Stack.Screen name="Menu" options={{contentStyle: {backgroundColor:'blue'}}} component={Menu} />
          ...
          <Stack.Screen name="OpinionThread" component={OpinionThread} options={({ route }:any) => ({ title: route.params.value })} />
          <Stack.Screen name="ReplyToTheThread" component={ReplyToTheThread} />
          <Stack.Screen name="SeeSubjectThread" component={SeeSubjectThread} options={({ route }:any) => ({ title: route.params.value })} />
