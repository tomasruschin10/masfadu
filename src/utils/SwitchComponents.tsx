...
export default function SwitchComponents({component, route, navigation}){
    switch (component) {
        ...
        case "Ofertas Laborales":
            return <JobOffers route={route} navigation={navigation} mainTitle={component} />
        case "Recursos y herramientas":
            return <ResourcesAndTools route={route} navigation={navigation} />
        case "Opiniones de materias":
            return <SubjectOpinions route={route} navigation={navigation} mainTitle={component} />
        case "Cursos, charlas y workshops":
            return <CoursesAndWorkshops route={route} navigation={navigation} mainTitle={component} />
        case "Materias":
