...
@Injectable()
export class MailPasswordCodeHtml {
          ...
          <main style="padding: 5%;">
              <div style="max-width: 1300px; margin: auto; border: 1px solid #ccc; border-radius: 20px;">
                  ...
                  <div style="padding: 30px;">
                      ...
                      <p style="margin-top: 5px;">Has hecho una solicitud para recuperar tu contraseña. Con el siguiente código puedes continuar con el proceso desde la app.</p>
                      <div style="text-align: center; margin: 30px 0;">
                          <b style="font-size: 20px;">{{token}}</b>
                      </div>
                      <p>
                          <b>Aviso!</b> este código expirará luego de haber sido ingresado.
                      </p>
                      <p style="margin: 0;">
