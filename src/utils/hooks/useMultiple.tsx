...
export const RenderOffer = ({
  ...
  return (
    <TouchableHighlight
      underlayColor="none"
      onPress={() =>
        navigation.navigate(redirect_to, {
          mainTitle: mainTitle,
          image: image,
          title: title,
    ...
    >
      <Box
        ...
        mb="2.5"
        rounded={8}
        borderColor={border ? "#EC5F5F" : "white"}
        borderWidth="2"
      >
        <Box flexDir={"row"} ml="4">
          ...
          <Box w="74%">
            ...
            <Text style={fontStyles.bodyText} fontSize={12} numberOfLines={2}>
              {text}
            </Text>
            <Text
          ...
          <Box mr="4">
            {
              ...
              >
                <Avatar
                  ...
                  _text={{
                    fontSize:
                      30 / (firstLetter?.length || 1) +
                      (firstLetter?.length * 1.5 || 1),
                    color: "#DA673A",
                  }}
                  bg={"#FBF0EB"}
                  mr="1"
          ...
          <Box w="70%" justifyContent={"center"}>
            ...
            {text ? (
              <Text
                style={[
                  fontStyles.bodyText,
                  { color: "#939aa0", fontSize: 13, marginTop: 2 },
                ]}
                fontWeight={"bold"}
              >
                {text}
            ...
            {time ? (
              <Text
                style={[fontStyles.poppins400, { fontSize: 12, marginTop: 2 }]}
                numberOfLines={2}
                fontSize={10}
              >
                {time}
