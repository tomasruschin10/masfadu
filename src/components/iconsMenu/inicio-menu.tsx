...
const xmlMenu = (color) => {
    return `
    <svg xmlns="http://www.w3.org/2000/svg" width="57" height="57" viewBox="0 0 57 57" fill="none">
    <path d="M28.5922 5.42822L35.8254 20.0819L52.0006 22.4462L40.2964 33.8461L43.0586 49.9511L28.5922 42.3434L14.1257 49.9511L16.8879 33.8461L5.18372 22.4462L21.359 20.0819L28.5922 5.42822Z" stroke=${color} stroke-width="4.01288" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
      `;
  };
